...
class LCDScreenController:
    ...
    def __init__(self, communication_queues):
        try:
            ...
            self.is_alive = False
            log.error('''LCD Screen controller 
                initialization problem, module 
                not critical, skipping''', e)
